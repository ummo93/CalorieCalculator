...
public class JavaAplication1 {
   ...
   public static void main(String[] args) throws FileNotFoundException {
      System.out.println("Эта программа позволяет рассчитать количество каллорий съеденных вами за день.\n День условно делиться на 3 этапа:\n - Завтрак,\n - Обед,\n - Ужин.\n Вы должны ввести каждый из приёмов пищи за каждый этап.\n Если вы ничего не ели в какой-то этап, выберите его и введите \'0\', когда вас спросят кол-во съеденных продуктов.\n Когда будете готовы начать, нажмите любую клавишу:");
      sc0.nextLine();
      ...
      String text = "\nВсего на " + date + " было съедено: " + List + "\n" + "\nОбщий калораж за день составил: " + Accumulator + " (Ккал)";
      System.out.println("\nХотите сохранить отчёт? Если да, нажмите Y или N, чтобы отказаться");
      String Choose1 = sc1.nextLine();
      if(Choose1.matches("(?i).*[Yy].*")) {
         System.out.println("\nУкажите папку, куда сохранить файл в формате \'\'C:/Program Files/\'\'");
   ...
   public static void userInputDate() {
      ...
      if(date.matches("(?i).*[/*].*")) {
         System.out.println("\nВы ввели недопустимый символ, дата будет = \'Test\'\n");
         date = "Test";
      }
   ...
   public static void userChoose1Processing() {
      for(int i = 0; i < 3; ++i) {
         ...
         if(choose == 1) {
            ...
            System.out.println("\nВы ввели неверный символ,у вас осталось " + (2 - i) + " попыток:\n");
