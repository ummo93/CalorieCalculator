...
//Scanner init
   ...
   public static void main(String[] args) throws FileNotFoundException {
      ...
      System.out.println("Эта программа позволяет рассчитать количество "
              + "каллорий съеденных вами за день.\n День условно делиться на "
              + "3 этапа:\n - Завтрак,\n - Обед,\n - Ужин.\n Вы должны ввести "
              + "каждый из приёмов пищи за каждый этап.\n Если вы ничего не ели "
              + "в какой-то этап, выберите его и введите \'0\', когда вас "
              + "спросят кол-во съеденных продуктов.\n Когда будете готовы "
              + "начать, нажмите любую клавишу:");
      ...
      System.out.println("\nХотите сохранить отчёт? Если да, нажмите Y или N, "
              + "чтобы отказаться");
